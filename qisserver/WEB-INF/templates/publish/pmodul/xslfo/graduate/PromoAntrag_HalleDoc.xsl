...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:date="http://exslt.org/dates-and-times" extension-element-prefixes="date"
	...
	<xsl:template match="publishDetail">
		...
		<xsl:variable name="fakId"><xsl:value-of select="/publishDetail/Promotion/Form/fak" /></xsl:variable>
		<xsl:variable name="fakName">
			<xsl:for-each select="Promotion/Faks/Fak">
		...
		<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
			<fo:layout-master-set>
				<fo:simple-page-master master-name="ersteSeite" page-height="297mm" page-width="210mm">
					<fo:region-body region-name="Body" margin-top="45mm" margin-left="15mm" margin-right="15mm" margin-bottom="15mm" background-color="white" />
					...
					<fo:region-start region-name="LRand" extent="15mm" background-color="white" />
			...
			<fo:page-sequence master-reference="global">
				...
				<fo:flow flow-name="Body" font-family="{$font}" font-size="10pt">
					<fo:block-container absolute-position="fixed" top="50mm" left="30mm" width="160mm"><!-- top=50 -> -69 -->
						<fo:block color="#000000" text-align="start" font-family="{$font}" font-weight="bold" hyphenate="true" language="de">
						...
						<fo:block color="#000000" font-family="{$font}" text-align="justify" hyphenate="true" language="de" padding-top="4em">
							im Institut <xsl:value-of select="Promotion/Form/inst" />
						</fo:block>
						...
						<fo:block color="#000000" text-align="start" font-family="{$font}" hyphenate="true" language="de" padding-top="2em">
							...
							<fo:block><xsl:text>Name und Geburtsname: </xsl:text><xsl:value-of select="Promotion/Form/name" /></fo:block>
							<fo:block><xsl:text>Vorname: </xsl:text><xsl:value-of select="Promotion/Form/vorname" /></fo:block>
							<fo:block><xsl:text>Geschlecht: </xsl:text><xsl:value-of select="Promotion/Form/gender" /></fo:block>
							<fo:block><xsl:text>Geburtsdatum: </xsl:text><xsl:value-of select="Promotion/Form/gebDate" /></fo:block>
							<fo:block><xsl:text>Geburtsort: </xsl:text><xsl:value-of select="Promotion/Form/gebOrt" /></fo:block>
							<fo:block><xsl:text>Geburtsland: </xsl:text><xsl:value-of select="Promotion/Form/gebLand" /></fo:block>
							<fo:block><xsl:text>Staatsangehörigkeit: </xsl:text><xsl:value-of select="Promotion/Form/national" /></fo:block>
						</fo:block>
						<fo:block color="#000000" text-align="start" font-family="{$font}" hyphenate="true" language="de" padding-top="2em">
							<fo:block>Wohnanschrift:</fo:block>
							<fo:block><xsl:text>Straße: </xsl:text><xsl:value-of select="Promotion/Form/street" /></fo:block>
							<fo:block><xsl:text>PLZ - Ort: </xsl:text><xsl:value-of select="Promotion/Form/plz" /><xsl:text> - </xsl:text><xsl:value-of select="Promotion/Form/ort" /></fo:block>
							<fo:block><xsl:text>Land: </xsl:text><xsl:value-of select="Promotion/Form/land" /></fo:block>
							<fo:block><xsl:text>Telefonnummer: </xsl:text><xsl:value-of select="Promotion/Form/tel" /></fo:block>
							<fo:block><xsl:text>E-Mail-Adresse: </xsl:text><xsl:value-of select="Promotion/Form/email" /></fo:block>
						</fo:block>
						<fo:block color="#000000" font-family="{$font}" text-align="justify" hyphenate="true" language="de" padding-top="2em">
							<fo:table>
								...
								<fo:table-body>
									...
									<xsl:call-template name="checkField">
										...
										<xsl:with-param name="isChecked"><xsl:choose><xsl:when test="Promotion/Form/appStatus = 'stat1'">1</xsl:when><xsl:otherwise>0</xsl:otherwise></xsl:choose></xsl:with-param>
									...
									<xsl:call-template name="checkField">
										...
										<xsl:with-param name="isChecked"><xsl:choose><xsl:when test="Promotion/Form/appStatus = 'stat2'">1</xsl:when><xsl:otherwise>0</xsl:otherwise></xsl:choose></xsl:with-param>
										<xsl:with-param name="additionalPre">0</xsl:with-param>
										<xsl:with-param name="additional">0</xsl:with-param>
									</xsl:call-template>
									<xsl:call-template name="checkField">
										<xsl:with-param name="text">Stipendiatin bzw. Stipendiat</xsl:with-param>
										<xsl:with-param name="isChecked"><xsl:choose><xsl:when test="Promotion/Form/appStatus = 'stat3'">1</xsl:when><xsl:otherwise>0</xsl:otherwise></xsl:choose></xsl:with-param>
										<xsl:with-param name="additionalPre">0</xsl:with-param>
										<xsl:with-param name="additional">0</xsl:with-param>
									</xsl:call-template>
									<xsl:call-template name="checkField">
										<xsl:with-param name="text">Externe Doktorandin bzw. externer Doktorand</xsl:with-param>
										<xsl:with-param name="isChecked"><xsl:choose><xsl:when test="Promotion/Form/appStatus = 'stat4'">1</xsl:when><xsl:otherwise>0</xsl:otherwise></xsl:choose></xsl:with-param>
										<xsl:with-param name="additionalPre">gegebenenfalls Institution, Adresse und Tel.-Nr.:</xsl:with-param>
										<xsl:with-param name="additional"><xsl:choose><xsl:when test="normalize-space(Promotion/Form/stat4Add) = ''">0</xsl:when><xsl:otherwise><xsl:value-of select="Promotion/Form/stat4Add" /></xsl:otherwise></xsl:choose></xsl:with-param>
									</xsl:call-template>
									<xsl:call-template name="checkField">
										<xsl:with-param name="text">Anderes</xsl:with-param>
										<xsl:with-param name="isChecked"><xsl:choose><xsl:when test="Promotion/Form/appStatus = 'stat5'">1</xsl:when><xsl:otherwise>0</xsl:otherwise></xsl:choose></xsl:with-param>
										<xsl:with-param name="additionalPre">gegebenenfalls Institution, Adresse und Tel.-Nr.:</xsl:with-param>
										<xsl:with-param name="additional"><xsl:choose><xsl:when test="normalize-space(Promotion/Form/stat5Add) = ''">0</xsl:when><xsl:otherwise><xsl:value-of select="Promotion/Form/stat5Add" /></xsl:otherwise></xsl:choose></xsl:with-param>
									</xsl:call-template>
								</fo:table-body>
							</fo:table>
						</fo:block>
							...
							<fo:table>
								...
								<fo:table-body>
									...
									<xsl:call-template name="checkField">
										...
										<xsl:with-param name="isChecked"><xsl:choose><xsl:when test="normalize-space(Promotion/Form/prog) = 'j'">1</xsl:when><xsl:otherwise>0</xsl:otherwise></xsl:choose></xsl:with-param>
										<xsl:with-param name="additionalPre">gegebenenfalls Institution und Bezeichnung des Programmes:</xsl:with-param>
										<xsl:with-param name="additional"><xsl:choose><xsl:when test="normalize-space(Promotion/Form/progAdd) = ''">0</xsl:when><xsl:otherwise><xsl:value-of select="Promotion/Form/progAdd" /></xsl:otherwise></xsl:choose></xsl:with-param>
									</xsl:call-template>
									<xsl:call-template name="checkField">
										<xsl:with-param name="text">Nein</xsl:with-param>
										<xsl:with-param name="isChecked"><xsl:choose><xsl:when test="normalize-space(Promotion/Form/binat) = 'j'">1</xsl:when><xsl:otherwise>0</xsl:otherwise></xsl:choose></xsl:with-param>
										<xsl:with-param name="additionalPre">0</xsl:with-param>
										<xsl:with-param name="additional">0</xsl:with-param>
									</xsl:call-template>
								</fo:table-body>
							...
							<fo:table>
								...
								<fo:table-body>
									...
									<xsl:call-template name="checkField">
										...
										<xsl:with-param name="additional"><xsl:choose><xsl:when test="normalize-space(Promotion/Form/binatAdd) = ''">0</xsl:when><xsl:otherwise><xsl:value-of select="Promotion/Form/binatAdd" /></xsl:otherwise></xsl:choose></xsl:with-param>
									</xsl:call-template>
									<xsl:call-template name="checkField">
										<xsl:with-param name="text">Nein</xsl:with-param>
										<xsl:with-param name="isChecked"><xsl:choose><xsl:when test="normalize-space(Promotion/Form/binat) = 'j'">1</xsl:when><xsl:otherwise>0</xsl:otherwise></xsl:choose></xsl:with-param>
					...
					<fo:block-container absolute-position="fixed" top="10mm" left="30mm" width="160mm"><!-- top=50 -> -69 -->
						<fo:block color="#000000" text-align="start" font-family="{$font}" hyphenate="true" language="de" padding-top="1em">
							...
							<fo:table>
								...
								<fo:table-body>
									<fo:table-row>
										<fo:table-cell><fo:block><xsl:value-of select="Promotion/Form/grad1" /></fo:block></fo:table-cell>
										<fo:table-cell><fo:block><xsl:value-of select="Promotion/Form/grad1wann" /></fo:block></fo:table-cell>
										<fo:table-cell><fo:block><xsl:value-of select="Promotion/Form/grad1wo" /></fo:block></fo:table-cell>
										<fo:table-cell><fo:block>
											<xsl:choose>
												<xsl:when test="Promotion/Form/grad1FH = 'j'">Ja</xsl:when>
												<xsl:otherwise>Nein</xsl:otherwise>
											</xsl:choose>
										</fo:block></fo:table-cell>
									</fo:table-row>
									<xsl:if test="normalize-space(Promotion/Form/grad2) != ''">
										<fo:table-row>
											<fo:table-cell><fo:block><xsl:value-of select="Promotion/Form/grad2" /></fo:block></fo:table-cell>
											<fo:table-cell><fo:block><xsl:value-of select="Promotion/Form/grad2wann" /></fo:block></fo:table-cell>
											<fo:table-cell><fo:block><xsl:value-of select="Promotion/Form/grad2wo" /></fo:block></fo:table-cell>
										<fo:table-cell><fo:block>
											<xsl:choose>
												<xsl:when test="Promotion/Form/grad2FH = 'j'">Ja</xsl:when>
												<xsl:otherwise>Nein</xsl:otherwise>
											</xsl:choose>
										</fo:block></fo:table-cell>
										</fo:table-row>
									</xsl:if>
									<xsl:if test="normalize-space(Promotion/Form/grad3) != ''">
										<fo:table-row>
											<fo:table-cell><fo:block><xsl:value-of select="Promotion/Form/grad3" /></fo:block></fo:table-cell>
											<fo:table-cell><fo:block><xsl:value-of select="Promotion/Form/grad3wann" /></fo:block></fo:table-cell>
											<fo:table-cell><fo:block><xsl:value-of select="Promotion/Form/grad3wo" /></fo:block></fo:table-cell>
										<fo:table-cell><fo:block>
											<xsl:choose>
												<xsl:when test="Promotion/Form/grad3FH = 'j'">Ja</xsl:when>
												<xsl:otherwise>Nein</xsl:otherwise>
											</xsl:choose>
										</fo:block></fo:table-cell>
										</fo:table-row>
						...
						<fo:block color="#000000" text-align="start" font-family="{$font}" hyphenate="true" language="de" padding-top="2em">
							...
							<fo:block><xsl:value-of select="Promotion/Form/gebiet" /></fo:block>
						</fo:block>
						<fo:block color="#000000" text-align="start" font-family="{$font}" hyphenate="true" language="de" padding-top="2em">
							...
							<fo:table>
								...
								<fo:table-column column-width="14.5cm"/>
								<fo:table-body>
									<xsl:for-each select="Promotion/AkadGrades/AkadGrade">
										<xsl:call-template name="checkField">
											<xsl:with-param name="text"><xsl:value-of select="ltxt" /> (<xsl:value-of select="dtxt" />)</xsl:with-param>
											<xsl:with-param name="isChecked"><xsl:choose><xsl:when test="gradid = /publishDetail/Promotion/Form/gettingGrad">1</xsl:when><xsl:otherwise>0</xsl:otherwise></xsl:choose></xsl:with-param>
											<xsl:with-param name="additionalPre">0</xsl:with-param>
											<xsl:with-param name="additional">0</xsl:with-param>
										</xsl:call-template>
									</xsl:for-each>
						...
						<fo:block color="#000000" text-align="start" font-family="{$font}" hyphenate="true" language="de" padding-top="2em">
							<fo:block><xsl:text>Arbeitstitel der Dissertation: </xsl:text><xsl:value-of select="Promotion/Form/title" /></fo:block>
							<fo:block><xsl:text>Beginn der Arbeit an der Dissertation: </xsl:text><xsl:value-of select="Promotion/Form/begin" /></fo:block>
						</fo:block>
						<fo:block color="#000000" text-align="start" font-family="{$font}" hyphenate="true" language="de" padding-top="2em">
							<fo:table>
								...
								<fo:table-body>
									...
									<fo:table-row>
										...
										<fo:table-cell><fo:block><xsl:value-of select="Promotion/Form/mentor1" /></fo:block></fo:table-cell>
									</fo:table-row>
									<fo:table-row>
										<fo:table-cell><fo:block>Wissenschaftl. Einrichtung, Institut:</fo:block></fo:table-cell>
										<fo:table-cell><fo:block><xsl:value-of select="Promotion/Form/mentor1Inst" /></fo:block></fo:table-cell>
									</fo:table-row>
									<xsl:if test="normalize-space(Promotion/Form/mentor2) != ''">
										<fo:table-row>
										...
										<fo:table-row>
											<fo:table-cell><fo:block>Akad. Titel, akad. Grad, Name, Vorname:</fo:block></fo:table-cell>
											<fo:table-cell><fo:block><xsl:value-of select="Promotion/Form/mentor2" /></fo:block></fo:table-cell>
										</fo:table-row>
										<fo:table-row>
											<fo:table-cell><fo:block>Wissenschaftl. Einrichtung, Institut:</fo:block></fo:table-cell>
											<fo:table-cell><fo:block><xsl:value-of select="Promotion/Form/mentor2Inst" /></fo:block></fo:table-cell>
										</fo:table-row>
									</xsl:if>
									<xsl:if test="normalize-space(Promotion/Form/mentor3) != ''">
										<fo:table-row>
											<fo:table-cell number-columns-spanned="2" padding-top="1em">
												<fo:block>Gegebenenfalls:</fo:block>
										...
										<fo:table-row>
											<fo:table-cell><fo:block>Akad. Titel, akad. Grad, Name, Vorname:</fo:block></fo:table-cell>
											<fo:table-cell><fo:block><xsl:value-of select="Promotion/Form/mentor3" /></fo:block></fo:table-cell>
										</fo:table-row>
										<fo:table-row>
											<fo:table-cell><fo:block>Wissenschaftl. Einrichtung, Institut:</fo:block></fo:table-cell>
											<fo:table-cell><fo:block><xsl:value-of select="Promotion/Form/mentor3Inst" /></fo:block></fo:table-cell>
										</fo:table-row>
									</xsl:if>
								</fo:table-body>
							</fo:table>
					...
					<fo:block-container absolute-position="fixed" top="10mm" left="30mm" width="160mm"><!-- top=50 -> -69 -->
						<fo:block color="#000000" text-align="start" font-family="{$font}" hyphenate="true" language="de" padding-top="1em">
							<fo:block>Kenntnisnahme und Bestätigung der Bereitschaft der betreuenden Hochschullehrerin bzw. des betreuenden Hochschullehrers / Confirmation of willingness of the mentoring professor (1) </fo:block>
							<fo:block font-size="8pt" padding-top="6em">Datum / Date  Unterschrift der Betreuerin bzw. des Betreuers / Signature of the mentor (1)</fo:block>
							<xsl:if test="normalize-space(Promotion/Form/mentor2) != ''">
								<fo:block padding-top="1em">Kenntnisnahme und Bestätigung der Bereitschaft der betreuenden Hochschullehrerin bzw. des betreuenden Hochschullehrers / Confirmation of willingness of the mentoring professor (2) </fo:block>
								<fo:block font-size="8pt" padding-top="6em">Datum / Date  Unterschrift der Betreuerin bzw. des Betreuers / Signature of the mentor (2)</fo:block>
							</xsl:if>
							<xsl:if test="normalize-space(Promotion/Form/mentor3) != ''">
								<fo:block padding-top="1em">Kenntnisnahme und Bestätigung der Bereitschaft der betreuenden Hochschullehrerin bzw. des betreuenden Hochschullehrers / Confirmation of willingness of the mentoring professor (3) </fo:block>
								<fo:block font-size="8pt" padding-top="6em">Datum / Date  Unterschrift der Betreuerin bzw. des Betreuers / Signature of the mentor (3)</fo:block>
							</xsl:if>
						</fo:block>
						<fo:block color="#000000" text-align="start" font-family="{$font}" hyphenate="true" language="de" padding-top="2em">
							...
							<fo:table>
								...
								<fo:table-body>
									<fo:table-row>
										...
										<fo:table-cell><fo:block>Dem Antrag auf Annahme als Doktorandin bzw. Doktorand für das Fachgebiet <xsl:value-of select="Promotion/Form/gebiet" /> wird entsprochen.</fo:block></fo:table-cell>
									</fo:table-row>
									<fo:table-row>
									...
									<fo:table-row>
										...
										<fo:table-cell padding-top="1em"><fo:block>Dem Antrag auf Annahme als Doktorandin bzw. Doktorand für das Fachgebiet <xsl:value-of select="Promotion/Form/gebiet" /> wird nicht entsprochen. Der Mitteilung über die Ablehnung des Antrages liegt eine gesonderte Begründung und Rechtsbehelfsbelehrung bei.</fo:block></fo:table-cell>
									</fo:table-row>
								</fo:table-body>
							</fo:table>
						</fo:block>
