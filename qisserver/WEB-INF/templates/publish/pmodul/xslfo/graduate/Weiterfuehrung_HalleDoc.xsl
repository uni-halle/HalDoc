				...
				<fo:flow flow-name="Body" font-family="{$font}" font-size="10pt">
					<fo:block-container absolute-position="fixed" top="119mm" left="30mm" width="170mm">
						<fo:block color="#000000" text-align="start" font-family="{$font}" font-weight="bold">
							Weiterführung Ihres Promotionsverfahrens
						</fo:block>
					</fo:block-container>
					...
					<fo:block-container absolute-position="fixed" top="143mm" left="30mm" width="165mm">
						<fo:block color="#000000" font-family="{$font}" text-align="justify" hyphenate="true" language="de">
							Ihr Promotionsverfahren wurde nach Eingang von … positiven Gutachten am <xsl:value-of select="Person/MyPromo/Process/forwardingForCommitee" /> mit der Auslage der Arbeit weitergeführt.
						</fo:block>
						<fo:block color="#000000" font-family="{$font}" text-align="justify" hyphenate="true" language="de" padding-top="1em">
							Gemäß § 9 Abs. 4 der Promotionsordnung der Einrichtung <xsl:value-of select="Person/MyInfos/Einrichtung/ltxt" /> liegen die Dissertation und die Gutachten 14 Tage im Dekanat zur Einsichtnahme aus. Nach Ende dieser Auslagefrist entscheidet der Promotionsausschuss über die Annahme oder Ablehnung der Dissertation.
						</fo:block>
						<fo:block color="#000000" font-family="{$font}" text-align="justify" hyphenate="true" language="de" padding-top="1em">
							Bei Annahme der Dissertation wird mit Ihnen ein Termin für die Verteidigung  in Abstimmung mit
							...
							Vorsitzenden der Promotionskommission und den Gutachterinnen bzw. Gutachtern vereinbart werden.
						</fo:block>
