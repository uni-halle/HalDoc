				...
				<fo:flow flow-name="Body" font-family="{$font}" font-size="10pt">
					<fo:block-container absolute-position="fixed" top="119mm" left="30mm" width="170mm">
						<fo:block color="#000000" text-align="start" font-family="{$font}" font-weight="bold">
							Nicht-Eröffnung Ihres Promotionsverfahrens aufgrund unvollständiger Unterlagen
						</fo:block>
					</fo:block-container>
					...
					<fo:block-container absolute-position="fixed" top="143mm" left="30mm" width="165mm">
						<fo:block color="#000000" font-family="{$font}" text-align="justify" hyphenate="true" language="de">
							Ihr Antrag auf Zulassung zum Promotionsverfahren ist am <xsl:value-of select="Person/MyPromo/Process/applicationOfAssumption" /> eingegangen. Leider kann das von Ihnen beantragte Promotionsverfahren damit nicht eröffnet werden, da nicht alle Unterlagen gemäß § 5 in Verbindung mit Anlage 3 der Promotionsordnung der Einrichtung <xsl:value-of select="Person/MyInfos/Einrichtung/ltxt" /> vorgelegt wurden.
						</fo:block>
						<fo:block color="#000000" font-family="{$font}" text-align="justify" hyphenate="true" language="de" padding-top="1em">
							Wir bitten Sie um Nachreichung folgender Unterlagen:
							<xsl:if test="Person/MyPromo/Infos/Nachreichung">
								<fo:list-block>
									<xsl:for-each select="Person/MyPromo/Infos/Nachreichung">
										<fo:list-item>
