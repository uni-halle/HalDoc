			...
			<fo:page-sequence master-reference="global">
				...
				<fo:flow flow-name="Body" font-family="{$font}" font-size="10pt">
					<fo:block-container absolute-position="absolute" top="5mm" left="5mm" width="165mm">
						<fo:block color="#000000" padding-top="5em" text-align="center" font-family="{$font}" font-size="12pt" hyphenate="true" language="de" font-weight="bold">
							<xsl:value-of select="Person/MyInfos/Einrichtung/ltxt" />
						</fo:block>
						<fo:block color="#000000" padding-top="5em" text-align="center" font-family="{$font}" font-size="14pt" font-weight="bold">
							Einladung
						</fo:block>
						...
						<fo:block color="#000000" padding-top="1em" text-align="center" font-family="{$font}" font-size="12pt">
							von
						</fo:block>
						<fo:block color="#000000" padding-top="1em" text-align="center" font-family="{$font}" font-size="12pt" font-weight="bold">
							<xsl:value-of select="$doktorand" />
						</fo:block>
						<fo:block color="#000000" padding-top="1em" text-align="center" font-family="{$font}" font-size="12pt" font-weight="bold">
							zum Thema
						</fo:block>
						<fo:block color="#000000" padding-top="1em" text-align="center" font-family="{$font}" font-size="12pt" hyphenate="true" language="de" font-weight="bold">
						...
						<fo:block color="#000000" padding-top="1em" text-align="center" font-family="{$font}" font-size="12pt" hyphenate="true" language="de" font-weight="bold">
							<xsl:value-of select="Person/MyPromo/Process/dateOfColloquium" />, <xsl:value-of select="Person/Form/TimeOfColloquium" />
						</fo:block>
						<fo:block color="#000000" padding-top="1em" text-align="center" font-family="{$font}" font-size="12pt">
							im
						</fo:block>
						<fo:block color="#000000" padding-top="1em" text-align="center" font-family="{$font}" font-size="12pt" hyphenate="true" language="de" font-weight="bold">
							<xsl:value-of select="Person/Form/PlaceOfColloquium" />
						</fo:block>
						<fo:block color="#000000" padding-top="1em" text-align="center" font-family="{$font}" font-size="12pt">
							Zu dieser Veranstaltung laden wir herzlich ein.
						</fo:block>
						<fo:block color="#000000" padding-top="2em" text-align="center" font-family="{$font}" font-size="12pt">
						...
						<fo:block color="#000000" text-align="center" font-family="{$font}" font-size="12pt">
