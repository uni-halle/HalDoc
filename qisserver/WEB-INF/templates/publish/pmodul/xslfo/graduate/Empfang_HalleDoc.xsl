				...
				<fo:flow flow-name="Body" font-family="{$font}" font-size="12pt">
					...
					<fo:block-container absolute-position="fixed" top="133.5mm" left="30mm" width="170mm">
						<fo:block color="#000000" text-align="start" font-family="{$font}">
							Hiermit bestätige ich den Erhalt der Urkunde zur Verleihung des akademischen Grades <xsl:value-of select="Person/MyPromo/AkadGrad" />. <fo:inline baseline-shift="super" font-size="10pt">1)</fo:inline>
						</fo:block>
					</fo:block-container>
					<fo:block-container absolute-position="fixed" top="170mm" left="30mm" width="165mm">
						<fo:block>
							<fo:table table-layout="fixed">
								...
								<fo:table-body>
									<fo:table-row>
										<fo:table-cell border-bottom-width="0.5pt" border-bottom-style="dashed">
											<fo:block />
										</fo:table-cell>
										<fo:table-cell>
											<fo:block />
									...
									<fo:table-row>
										...
										<fo:table-cell>
											<fo:block>Unterschrift</fo:block>
										</fo:table-cell>
									</fo:table-row>
								</fo:table-body>
							</fo:table>
					...
					<fo:block-container absolute-position="fixed" top="180mm" left="30mm" width="170mm">
						<fo:block color="#000000" text-align="start" font-family="{$font}">
							<fo:inline baseline-shift="super" font-size="10pt">1)</fo:inline> Nach Empfang bitte unterschrieben an das Dekanat bzw. die Geschäftsstelle zurück.
						</fo:block>
					</fo:block-container>
				</fo:flow>
			</fo:page-sequence>
